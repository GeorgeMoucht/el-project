...
<div class="header-cnt">
    <div class="bg-image header-image-vas">
        <div class="filter"></div>

    </div>
    <div class="header animate__animated animate__fadeIn">
        <h1>Βασίλης Βεηλεκτσίδη</h1>
    </div>
</div>

<div class="container">
    <p class="lead">
        Ο Βασίλειος Βεηλικτσίδης γεννήθηκε το 1885 στην Αμισό (Σαμψούντα) του Πόντου και  πέθανε στις Σέρρες το 1959.
        Σπούδασε μουσική στη γενέτειρά του και κατόπιν στην Κωνσταντινούπολη. Σταδιοδρόμησε αρχικά στην Αμισό, όπου υπήρξε 
        και διευθυντής μαντολινάτας θηλέων. 
    </p>
    <p class="p lead">
...
<div id="vasilisModal" class="modal">
  <span class="close cursor" onclick="closeModal('vasilisModal')">&times;</span>
